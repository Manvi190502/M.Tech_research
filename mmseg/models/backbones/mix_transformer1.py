...
class mit_b0_binary(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(mit_b0_binary, self).__init__(
...
@BACKBONES.register_module()
class mit_b1_binary(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(mit_b1_binary, self).__init__(
...
@BACKBONES.register_module()
class mit_b2_binary(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(mit_b2_binary, self).__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
...
@BACKBONES.register_module()
class mit_b3_binary(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(mit_b3_binary, self).__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
...
@BACKBONES.register_module()
class mit_b4_binary(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(mit_b4_binary, self).__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
...
@BACKBONES.register_module()
class mit_b5_binary(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(mit_b5_binary, self).__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
