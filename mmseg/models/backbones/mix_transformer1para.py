...
class BinaryLinear(nn.Linear):
    def forward(self, input):
        ...
        bw = self.weight.sign()
        bw = bw.detach() - self.weight.detach() + self.weight
...
class Mlp(nn.Module):
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, drop=0.):
        ...
        self.fc1 = BinaryLinear(in_features, hidden_features)
        self.dwconv = DWConv(hidden_features)
        self.act = act_layer()
        self.fc2 = BinaryLinear(hidden_features, out_features)
...
class Attention(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0., sr_ratio=1):
        ...
        self.q = BinaryLinear(dim, dim, bias=qkv_bias)
        self.kv = BinaryLinear(dim, dim * 2, bias=qkv_bias)
        self.proj = BinaryLinear(dim, dim)
...
class DWConv(nn.Module):
    def __init__(self, dim=768):
        ...
        self.dwconv = BinaryConv2d(dim, dim, 3, 1, 1, bias=True, groups=dim)
...
class mit_b0_para(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(mit_b0_para, self).__init__(
            patch_size=4, embed_dims=[16, 32, 80, 128], num_heads=[1, 2, 5, 8], mlp_ratios=[2, 2, 2, 2],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[1, 2, 2, 1], sr_ratios=[8, 4, 2, 1],
            drop_rate=0.0, drop_path_rate=0.1)


@BACKBONES.register_module()
class mit_b1_para(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(mit_b1_para, self).__init__(
...
@BACKBONES.register_module()
class mit_b2_para(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(mit_b2_para, self).__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
...
@BACKBONES.register_module()
class mit_b3_para(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(mit_b3_para, self).__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
...
@BACKBONES.register_module()
class mit_b4_para(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(mit_b4_para, self).__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
...
@BACKBONES.register_module()
class mit_b5_para(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(mit_b5_para, self).__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[3, 6, 40, 3], sr_ratios=[8, 4, 2, 1],
            drop_rate=0.0, drop_path_rate=0.1)

@BACKBONES.register_module()
class mit_b0_para1(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(mit_b0_para1, self).__init__(
            patch_size=4, embed_dims=[32, 64, 160, 256], num_heads=[1, 2, 5, 8], mlp_ratios=[3,3,3,3],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[2, 2, 2, 1], sr_ratios=[8, 4, 2, 1],
            drop_rate=0.0, drop_path_rate=0.1)