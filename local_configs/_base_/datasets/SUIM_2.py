# -*- coding: utf-8 -*-
# Improved SUIM augmentation for better mIoU
...
train_pipeline = [
    ...
    dict(
        ...
        meta_keys=[
            ...
            'flip', 'flip_direction'   # keep these
        ]
    )
]
# ---------------- TEST PIPELINE ----------------
...
"""
gmentation	Why it matters
Gaussian Blur	simulates underwater scattering 🌊
Noise	simulates particles
ColorJitter	underwater color distortion
CLAHE	improves contrast
Brightness/Contrast	lighting variation
Flip + Rotate	geometric robustness
"""